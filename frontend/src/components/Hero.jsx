  ...
  return (
    <div className='flex flex-col sm:flex-row' style={{ backgroundColor: 'rgb(255, 218, 214)' }}>
      ...
      <div className='w-full sm:w-1/2 flex items-center justify-center py-10 sm:py-0'>
        <div className='text-[#414141] flex flex-col items-start justify-center gap-y-4'>
          ...
          <div className='sm:mt-4 self-center'>
            <NavLink to='/collection'>
              <button className='bg-[#414141] text-white font-semibold text-sm md:text-base py-2 px-5 rounded-lg shadow-lg bg-black hover:bg-[#333] transition-colors duration-300'>SHOP NOW</button>
            </NavLink>
          </div>
        </div>
      </div>
