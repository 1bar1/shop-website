...
const Login = () => {
  ...
  const {token, setToken, navigate, backendUrl, loginUser, registerUser} = useContext(ShopContext)
  ...
  return (
    <form onSubmit={onSubmitHnadler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
      ...
      <button className='bg-black text-white font-light px-8 py-2 mt-4 hover:bg-[#0f0f0f] transition-colors duration-300'>{currentState === 'Login' ? 'Sign In' : 'Sign Up'}</button>
    </form>
  )
}
